...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  ...
  Future<void> _pickAndUploadImage() async {
    final XFile? image = await _picker.pickImage(
      ...
      imageQuality: 70, // Comprimăm imaginea pentru a economisi spațiu
      maxWidth: 800,
    );
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Pentru a deveni șofer partener Friends, folosiți opțiunea "Activare cod mod Șofer Friends" din meniul principal cu codul primit prin email/SMS.',
