...
// TEST_AI_SIMPLE_FINAL.DART
// Script final simplu pentru testarea AI-ului de solicitare curse
...
class AIRideTestScript {
  ...
  static void testCompleteFlow() {
    ...
    _runTestSteps(testSteps, "Test Flux Complet Autonom");
  }

  // Test 2: Destinație neclară - AI cere clarificări
  static void testUnclearDestination() {
    ...
    _runTestSteps(testSteps, "Test Destinație Neclară");
  }

  // Test 3: Utilizatorul schimbă decizia
  static void testChangingMind() {
    ...
    _runTestSteps(testSteps, "Test Schimbare Decizie");
  }

  // Test 4: Verificare autonomie AI (AUTONOM)
  static void testAIAutonomy() {
  ...
  // Test 5: Verificare fluxul complet autonom
  static void testCompleteAutonomousFlow() {
  ...
  static void _runTestSteps(List<TestStep> steps, String testName) {
    print("\n📝 Rulare: $testName");
