...
import 'package:friendsride_app/widgets/enhanced_price_estimate_widget.dart';
...
class RideConfirmationView extends StatelessWidget {
  ...
  String _getCategoryName(RideCategory category) {
    switch (category) {
      ...
      case RideCategory.family: return 'Family';
      case RideCategory.energy: return 'Energy';
      case RideCategory.best: return 'Best';
    }
  }
    ...
    return ListView(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: Text(
            stops.isEmpty 
              ? 'Confirmă ${_getCategoryName(selectedCategory)} (${fares[selectedCategory]?['totalCost']?.toStringAsFixed(2)} lei)'
              : 'Confirmă cu ${stops.length} opriri (${fares[selectedCategory]?['totalCost']?.toStringAsFixed(2)} lei)'
          ),
        ),
      ],
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              '+${(stops.length * 2).toStringAsFixed(0)} RON pentru opriri',
              style: TextStyle(
                fontSize: 12,
