...
class _VoiceInputButtonState extends State<VoiceInputButton>
  ...
  void dispose() {
    ...
    // 🚀 NU dispose() singleton-ul - e partajat global
    super.dispose();
  }
  ...
  Future<void> _initializeVoice() async {
    try {
      ...
      if (permissionStatus.isPermanentlyDenied) {
        _showError('Permisiunea pentru microfon este permanent refuzată. Mergi la Setări → Aplicații → FriendsRide → Permisiuni → Microfon');
        return;
      }
  ...
  Widget build(BuildContext context) {
    ...
    try {
      voiceIntegration = Provider.of<FriendsRideVoiceIntegration>(context, listen: true);
