    ...
    switch (widget.category) {
      case RideCategory.standard:
        return CategoryColors(
          ...
          gradient: LinearGradient(colors: [AppColors.standardCategory, AppColors.primaryLight], begin: Alignment.topLeft, end: Alignment.bottomRight),
        );
      ...
      case RideCategory.energy:
        return CategoryColors(
          ...
          gradient: LinearGradient(colors: [AppColors.energyCategory, AppColors.secondaryLight], begin: Alignment.topLeft, end: Alignment.bottomRight),
        );
      case RideCategory.best:
        return CategoryColors(
          primary: AppColors.bestCategory,
          background: AppColors.bestCategory.withAlpha(25),
          gradient: LinearGradient(colors: [AppColors.bestCategory, const Color(0xFF9C27B0)], begin: Alignment.topLeft, end: Alignment.bottomRight),
        );
    }
  }
  ...
  Widget _buildIcon(CategoryColors colors) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: widget.isSelected 
            ? Border.all(color: Colors.white.withAlpha(76), width: 1)
            : null,
      ),
      child: Icon(
        widget.icon,
...
class _PremiumCategoryCardState extends State<PremiumCategoryCard>
          ...
          return Transform.scale(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: widget.isSelected ? null : Border.all(color: AppColors.textDisabled.withAlpha(51), width: 1),
              ),
              child: Stack(
                children: [
    ...
    return Positioned(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.star_rounded, color: Colors.white, size: AppConstants.iconS,),
  ...
  Widget _buildEnhancedPriceSection() {
    final totalCost = widget.fareDetails['totalCost'] ?? 0.0;
    ...
    return Column(
      ...
      children: [
        Text(
          '${totalCost.toStringAsFixed(2)} RON',
          style: AppTextStyles.priceText.copyWith(
            color: widget.isSelected ? AppColors.textOnPrimary : AppColors.primary,
            fontSize: 20,
            fontWeight: FontWeight.bold,
          ),
          maxLines: 1,
        ...
        const SizedBox(height: AppConstants.spacingXS),
        if (widget.isSelected) _buildSelectedIndicator() else _buildPriceBreakdown(),
      ],
    );
  }
  ...
  Widget _buildSelectedIndicator() {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.check_circle_rounded, color: AppColors.textOnPrimary, size: AppConstants.iconS,),
          const SizedBox(width: AppConstants.spacingXS),
          Text(
            'SELECTAT',
            style: AppTextStyles.labelSmall.copyWith(
  ...
  Widget _buildPriceBreakdown() {
    final baseFare = widget.fareDetails['baseFare'] ?? 0.0;
    return Text(
      'Tarif de bază: ${baseFare.toStringAsFixed(2)} RON',
