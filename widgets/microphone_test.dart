  ...
  Future<void> _initSpeech() async {
    try {
      ...
      if (micPermission.isDenied) {
        setState(() {
          _status = '❌ Microphone permission denied. Please enable in Settings → Apps → FriendsRide → Permissions → Microphone';
        });
        return;
      }
      ...
      if (micPermission.isPermanentlyDenied) {
        setState(() {
          _status = '❌ Microphone permanently denied. Go to Settings → Apps → FriendsRide → Permissions → Microphone → Allow';
        });
        return;
      }
