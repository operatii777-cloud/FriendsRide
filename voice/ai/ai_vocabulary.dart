...
class AIVocabulary {
  ...
  static const Map<String, String> aiResponses = {
    ...
    'greeting_response': 'Bună ziua! Sunt asistentul FriendsRide. Cu ce vă pot ajuta?',
    ...
    switch (intent) {
      ...
      case 'POLITE_CONVERSATION':
        ...
        switch (conversationType) {
          case 'greeting':
            return 'Bună ziua! Sunt asistentul FriendsRide. Cu ce vă pot ajuta?';
          case 'thanks':
