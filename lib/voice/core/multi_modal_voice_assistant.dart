...
/// Multi-Modal Voice Assistant for FriendsRide
...
class VoiceModeManagerImpl implements VoiceModeManager {
  ...
  @override
  Future<ConversationResponse> applyMode(ConversationResponse response, VoiceMode mode) async {
...
class VoiceCommandProcessorImpl implements VoiceCommandProcessor {
  ...
  @override
  Future<SpeechOutput> generateSpeech(String text, {VoiceCharacteristics? characteristics}) async {
    // Mock implementation
    return SpeechOutput(
      text: text,
      audio: null,
      duration: Duration(seconds: text.length ~/ 10),
      characteristics: characteristics ?? VoiceCharacteristics(
        formalityLevel: FormalityLevel.normal,
        emotionLevel: EmotionLevel.medium,
        emotionType: EmotionType.neutral,
        culturalContext: CulturalContext.romanian,
  ...
  @override
  Future<List<VisualElement>> generateVisualElements(ConversationResponse response, VisualStyle style) async {
    // Mock implementation
    return [
      VisualElement(
        type: 'text',
        properties: {'content': response.text},
        duration: const Duration(seconds: 3),
      ),
    ];
  }
  ...
  @override
  Future<HapticOutput> generateHapticFeedback(ConversationResponse response, HapticPattern pattern) async {
    // Mock implementation
    return HapticOutput(
  ...
  @override
  Future<void> updateVoiceCharacteristics(VoiceCharacteristics characteristics) async {
    // Mock implementation
  }
