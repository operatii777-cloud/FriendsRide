...
class _ScheduledRideNotificationsScreenState
  ...
  Future<void> _addRide() async {
    ...
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text('Adaugă cursă programată', style: AppTextStyles.heading4),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Curse programate', style: AppTextStyles.heading3),
      ...
      body: _rides.isEmpty
          ? Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.schedule, size: 72, color: AppColors.textHint),
                  const SizedBox(height: 16),
                  Text(
