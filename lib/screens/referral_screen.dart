...
class _ReferralScreenState extends State<ReferralScreen> {
  ...
  void _shareCode() {
    if (_referralCode == null) return;
    Share.share(
      'Folosește codul meu de referral $_referralCode pe FriendsRide și primești o cursă gratuită! Descarcă aplicația: https://friendsride.app',
      subject: 'Cod referral FriendsRide',
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Referral', style: AppTextStyles.heading3),
  ...
  Widget _buildHowItWorks() {
    final steps = [
      _StepItem(Icons.share_outlined, 'Distribuie codul tău prietenilor'),
      _StepItem(Icons.person_add_outlined,
          'Prietenii se înregistrează cu codul tău'),
      _StepItem(Icons.directions_car_outlined,
          'Fac prima cursă verificată'),
      _StepItem(Icons.card_giftcard_outlined,
    ...
    return FutureBuilder<List<Referral>>(
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Referralurile tale', style: AppTextStyles.heading4),
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            color:
                (statusColors[referral.status] ?? Colors.grey).withOpacity(0.15),
