...
class _GiftRideScreenState extends State<GiftRideScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Cadou Cursă', style: AppTextStyles.heading3),
    ...
    return SingleChildScrollView(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text('Destinatar', style: AppTextStyles.heading4),
            ...
            Text('Suma (RON)', style: AppTextStyles.heading4),
            const SizedBox(height: 12),
            Wrap(
              spacing: 10,
              runSpacing: 10,
            ...
            const SizedBox(height: 24),
            Text('Mesaj personalizat', style: AppTextStyles.heading4),
            const SizedBox(height: 12),
            TextFormField(
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    (statusColors[gift.status] ?? Colors.grey).withOpacity(0.15),
