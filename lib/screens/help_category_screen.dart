...
import 'package:friendsride_app/content/help_content.dart'; // Importăm conținutul
import 'package:friendsride_app/screens/help_article_screen.dart'; // Importăm noul ecran de articol
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          String title = topics.keys.elementAt(index);
          IconData icon = topics.values.elementAt(index);
          
          // Obținem conținutul articolului din "biblioteca" noastră
          // Dacă nu găsim conținut, trimitem un text implicit.
          List<Widget> content = HelpContent.articles[title] ?? 
